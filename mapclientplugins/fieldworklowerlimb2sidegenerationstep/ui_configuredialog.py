...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(0, QFormLayout.FieldRole, self.comboBox_regmode)
        ...
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.spinBox_pcsToFit)
        ...
        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.doubleSpinBox_mWeight)
        ...
        self.formLayout.setWidget(4, QFormLayout.FieldRole, self.doubleSpinBox_markerRadius)
        ...
        self.formLayout.setWidget(5, QFormLayout.FieldRole, self.doubleSpinBox_skinPad)
        ...
        self.formLayout.setWidget(7, QFormLayout.FieldRole, self.checkBox_GUI)
